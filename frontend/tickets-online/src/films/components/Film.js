...
const Film = ({onFilmClick, id, name, description, startRentDate, endRentDate}) => (
  <a onClick={(e) => onFilmClick(e, id)} href="#" className="film-item list-group-item list-group-item-action flex-column align-items-start">
