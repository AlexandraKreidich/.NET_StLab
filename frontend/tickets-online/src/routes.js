...
const Routes = () => {
    return (
      <Switch> 
        ...
        <AuthRoute path='/register' component={RegisterForm}
          nonAuthenticationRequired
        />
        <AuthRoute path='/films/:filmId/sessions' component={SessionsListContainer}
          nonAuthenticationRequired
        />
        <AuthRoute path='/films' component={FilmListContainer}
          nonAuthenticationRequired
        />
      </Switch>
    )
  ...
  export default withRouter(connect(
    state => ({ email: state.user.userData.email })
  )(Routes))
