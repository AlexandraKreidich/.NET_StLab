        ...
        return (
            <div className="container-fluid search-bar">
                {this.props.isFiltersLoading
                    ...
                    <Select onChange={this.onCitiesSelectChange} name={'All Cities'} options={this.props.filters.cities} />
                    <Select onChange={this.onCinemasSelectChange} name={'All Cinemas'} options={this.props.filters.cinemas} />
                    <input type="number" onInput={this.onFreePlacesInputChange} className="search-bar__input" placeholder="free places" />
                    <DatePicker className='search-bar__select'
