...
GO
PRINT N'Rename refactoring operation with key 1115a48b-4e81-48f1-bc28-c0c05574f68e is skipped, element [dbo].[additional_service].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 81d485f4-462b-4aca-be79-797ac68226fc is skipped, element [dbo].[Cinema] (SqlTable) will not be renamed to [cinema]';


GO
PRINT N'Rename refactoring operation with key 639a2918-d47a-4909-aed1-47898e7f12ad is skipped, element [dbo].[cinema].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key a4d612e0-c743-48b2-8e5c-b55b17486032 is skipped, element [dbo].[hall].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key d36c8bf9-ee3e-4239-9420-0b711a6d3755 is skipped, element [dbo].[hall_scheme].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 50449530-fe0e-4777-8d80-c6f8f8941d7a is skipped, element [dbo].[session].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 53dce2fe-fd49-468d-b241-e16ba628a239 is skipped, element [dbo].[film].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key d3001896-c39a-41e6-9750-dafc2929fe84 is skipped, element [dbo].[price].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 36961592-7ce9-4f9b-909d-8003a915278b is skipped, element [dbo].[place_type].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 7f7cfe30-d48e-4a0a-9922-ebd33d4d2825 is skipped, element [dbo].[ticket].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key c342a032-834b-49e4-acd1-b48a6bb9ad61 is skipped, element [dbo].[user].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 5222da93-ba6d-429f-a1fe-b48d17962e0e is skipped, element [dbo].[user].[name] (SqlSimpleColumn) will not be renamed to first_name';


GO
PRINT N'Rename refactoring operation with key 6d46f940-aba9-4084-8e1d-d03e82f9a83c is skipped, element [dbo].[user].[role_id] (SqlSimpleColumn) will not be renamed to user_role_id';


GO
PRINT N'Rename refactoring operation with key d417d5d1-a193-4fff-94a4-27c0f78033b8 is skipped, element [dbo].[user_role].[Id] (SqlSimpleColumn) will not be renamed to id';


GO
PRINT N'Rename refactoring operation with key 48b341c3-24c5-410d-8e70-2ef124f0a834 is skipped, element [dbo].[user_role].[role] (SqlSimpleColumn) will not be renamed to name';
