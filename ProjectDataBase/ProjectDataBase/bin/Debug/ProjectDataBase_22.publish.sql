...
BEGIN TRY
	...
	VALUES 
		...
		(4, 2, convert(DATE, '20171008'), '18.15.00'),
		(5, 2, convert(DATE, '20171007'), '18.15.00'),
		(6, 2, convert(DATE, '20171006'), '18.15.00'),
		(7, 3, convert(DATE, '20171008'), '14.15.00'),
		(8, 3, convert(DATE, '20171006'), '14.15.00'),
		(9, 3, convert(DATE, '20171006'), '14.15.00'),
		(10, 4, convert(DATE, '20171008'), '11.15.00'),
		(1, 4, convert(DATE, '20171007'), '11.15.00'),
		(2, 4, convert(DATE, '20171006'), '11.15.00'),
		(3, 5, convert(DATE, '20171008'), '17.15.00'),
		(4, 5, convert(DATE, '20171007'), '17.15.00'),
		(5, 5, convert(DATE, '20171006'), '17.15.00'),
		(6, 6, convert(DATE, '20171008'), '19.15.00'),
		(7, 6, convert(DATE, '20171007'), '19.15.00'),
		(8, 6, convert(DATE, '20171006'), '19.15.00'),
		(9, 7, convert(DATE, '20171008'), '20.15.00'),
		(10, 7, convert(DATE, '20171007'), '21.15.00'),
		(1, 7, convert(DATE, '20171006'), '22.15.00'),
		(2, 8, convert(DATE, '20171008'), '19.15.00'),
		(3, 8, convert(DATE, '20171007'), '19.15.00'),
		(4, 8, convert(DATE, '20171006'), '19.15.00'),
		(5, 9, convert(DATE, '20171008'), '19.15.00'),
		(6, 9, convert(DATE, '20171007'), '19.15.00'),
		(7, 9, convert(DATE, '20171006'), '19.15.00'),
		(8, 10, convert(DATE, '20171008'), '12.15.00'),
		(9, 10, convert(DATE, '20171007'), '12.15.00'),
		(10, 10, convert(DATE, '20171006'), '12.15.00')
