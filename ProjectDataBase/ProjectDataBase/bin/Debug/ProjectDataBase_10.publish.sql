...
GO
ALTER TABLE [dbo].[Cinema] ALTER COLUMN [city] VARCHAR (MAX) NULL;

ALTER TABLE [dbo].[Cinema] ALTER COLUMN [name] VARCHAR (MAX) NULL;
...
BEGIN TRY
	...
	SELECT id FROM dbo.Cinema WHERE Cinema.name='Silver Screen';
	SELECT id FROM dbo.Cinema WHERE Cinema.name='Silver Screen';
	SELECT id FROM dbo.Cinema WHERE Cinema.name='Silver Screen';
	SELECT id FROM dbo.Cinema WHERE Cinema.name='Red star';
		/*(1),
		(1),
		(1),
		(2),
