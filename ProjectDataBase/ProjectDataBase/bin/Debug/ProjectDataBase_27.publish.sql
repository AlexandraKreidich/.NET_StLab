...
BEGIN TRY
	...
	VALUES 
		(1, 1, convert(DATE, '20171008', 112), '12.15.00'),
		(2, 1, convert(DATE, '20171007', 112), '12.15.00'),
		(3, 1, convert(DATE, '20171006', 112), '12.15.00'),
		(4, 2, convert(DATE, '20171008', 112), '18.15.00'),
		(5, 2, convert(DATE, '20171007', 112), '18.15.00'),
		(6, 2, convert(DATE, '20171006', 112), '18.15.00')
